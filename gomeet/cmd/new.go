...
func init() {
	...
	newCmd.PersistentFlags().StringVar(&extraServeFlags, "extra-serve-flags", "", "extra serve flags passed to gRPC server format [name-of-flag|flag description <no comma, no semicolon, no colon>] (comma separated)")
